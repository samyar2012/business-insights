...
const { applyUxModelLayer, isUxModelEnabled } = require('./uxModelService')



async function applyScoreEnhancementsAsync(profilePayload, context) {

  profilePayload.crawl_ux_ui_score =

    profilePayload.crawl_ux_ui_score ??

    profilePayload.deterministic_ux_ui_score ??

    profilePayload.ux_ui_score



  if (isUxModelEnabled()) {

    await applyUxModelLayer(profilePayload, {

      uxFeatures: context.uxFeatures,
...
async function rehydrateWebProfileScores({
  ...
  profilePayload.crawl_ux_ui_score = profilePayload.ux_ui_score

  await applyScoreEnhancementsAsync(profilePayload, { business, uxFeatures })
