    ...
    <div className="mx-auto max-w-5xl">
      <header className="app-stagger">
        ...
        <p className="app-page-subtitle max-w-2xl">
          Every tool connects to the same workflow: analyze your website, review the report, execute the
          growth roadmap, ask the coach, then rescan. Preview tools are on the roadmap and not enabled yet.
        </p>
      </header>
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1">
                      ...
                      <span className="app-link mt-2 inline-block text-xs font-semibold">
                        {tool.live ? 'Open tool ->' : 'See preview ->'}
                      </span>
                    </span>
                  </Link>
                </li>
